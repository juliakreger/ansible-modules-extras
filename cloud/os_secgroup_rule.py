...
short_description: Add/Delete Nova security groups rules from an existing security group
extends_documentation_fragment: openstack
description:
   - Add or Remove security group rule from an existing security group
options:
   state:
     description:
...
- os_secgroup_rule:  username=admin
                password=passme
                project_name=admin
